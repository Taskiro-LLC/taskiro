...
var UserForm = /** @class */ (function () {
    function UserForm() {
        ...
        this.typeSelect = document.querySelector('#account-type');
    }
    UserForm.prototype.validateFields = function () {
        var isValid = true;
    ...
    UserForm.prototype.clearValidation = function () {
    ...
    UserForm.prototype.getUser = function () {
        if (!this.validateFields()) {
            ...
            var mismatched = document.querySelector('.mismatched');
